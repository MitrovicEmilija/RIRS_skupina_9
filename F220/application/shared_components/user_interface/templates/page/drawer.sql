...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11606444413457015)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11606734352457026)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11607064421457026)
,p_page_template_id=>wwv_flow_imp.id(11606444413457015)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11607338547457028)
,p_page_template_id=>wwv_flow_imp.id(11606444413457015)

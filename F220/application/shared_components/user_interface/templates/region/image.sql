...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11679102236457103)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11679409237457104)
,p_plug_template_id=>wwv_flow_imp.id(11679102236457103)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11679769822457104)
,p_plug_template_id=>wwv_flow_imp.id(11679102236457103)
,p_name=>'Sub Regions'

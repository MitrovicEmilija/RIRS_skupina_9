...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11701229095457120)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11701507188457120)
,p_plug_template_id=>wwv_flow_imp.id(11701229095457120)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11701845264457121)
,p_plug_template_id=>wwv_flow_imp.id(11701229095457120)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11702107191457121)
,p_plug_template_id=>wwv_flow_imp.id(11701229095457120)
,p_name=>'Button Start'

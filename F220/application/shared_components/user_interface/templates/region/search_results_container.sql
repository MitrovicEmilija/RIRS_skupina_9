...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11706252643457125)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11706585448457125)
,p_plug_template_id=>wwv_flow_imp.id(11706252643457125)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11706845891457125)
,p_plug_template_id=>wwv_flow_imp.id(11706252643457125)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11707131032457125)
,p_plug_template_id=>wwv_flow_imp.id(11706252643457125)
,p_name=>'Sub Regions'

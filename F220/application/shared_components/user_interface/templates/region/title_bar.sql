...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11721321945457137)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11721657667457137)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11721956859457137)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11722282926457137)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11722511560457137)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11722832225457139)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11723157646457139)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11723431203457139)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11723735983457139)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11724001697457139)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11724305124457139)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11724672154457139)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11724901997457140)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11725241265457140)
,p_plug_template_id=>wwv_flow_imp.id(11721321945457137)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false

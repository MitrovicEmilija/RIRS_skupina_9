...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11718742820457134)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11719059043457135)
,p_plug_template_id=>wwv_flow_imp.id(11718742820457134)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11719339288457135)
,p_plug_template_id=>wwv_flow_imp.id(11718742820457134)
,p_name=>'Tabs'

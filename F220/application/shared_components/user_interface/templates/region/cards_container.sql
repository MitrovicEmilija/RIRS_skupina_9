...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11649489293457079)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11649747640457081)
,p_plug_template_id=>wwv_flow_imp.id(11649489293457079)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11650060107457081)
,p_plug_template_id=>wwv_flow_imp.id(11649489293457079)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11650383326457081)
,p_plug_template_id=>wwv_flow_imp.id(11649489293457079)
,p_name=>'Sub Regions'

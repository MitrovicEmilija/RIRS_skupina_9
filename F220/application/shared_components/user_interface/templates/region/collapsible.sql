...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11661228555457089)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11661539828457089)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11661875708457089)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11662114653457090)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11662460099457090)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11662777836457090)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11663072145457090)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11663363511457090)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11663687657457090)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11663937558457090)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11664262624457092)
,p_plug_template_id=>wwv_flow_imp.id(11661228555457089)
,p_name=>'Sub Regions'

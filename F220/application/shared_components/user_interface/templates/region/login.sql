...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11703798919457121)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11704060330457123)
,p_plug_template_id=>wwv_flow_imp.id(11703798919457121)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11704313348457123)
,p_plug_template_id=>wwv_flow_imp.id(11703798919457121)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11704603576457123)
,p_plug_template_id=>wwv_flow_imp.id(11703798919457121)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11704901532457123)
,p_plug_template_id=>wwv_flow_imp.id(11703798919457121)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11705262161457123)
,p_plug_template_id=>wwv_flow_imp.id(11703798919457121)
,p_name=>'Sub Regions'

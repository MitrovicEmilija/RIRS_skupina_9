...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11675604595457100)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11675901709457101)
,p_plug_template_id=>wwv_flow_imp.id(11675604595457100)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11676220696457101)
,p_plug_template_id=>wwv_flow_imp.id(11675604595457100)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11676586488457101)
,p_plug_template_id=>wwv_flow_imp.id(11675604595457100)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11676897578457101)
,p_plug_template_id=>wwv_flow_imp.id(11675604595457100)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11677146559457101)
,p_plug_template_id=>wwv_flow_imp.id(11675604595457100)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false

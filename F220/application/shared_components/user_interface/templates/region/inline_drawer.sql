...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11689121657457110)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11689487974457110)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11689778307457112)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11690078599457112)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11690322999457112)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11690646952457112)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11690911493457112)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11691294817457112)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11691525581457112)
,p_plug_template_id=>wwv_flow_imp.id(11689121657457110)
,p_name=>'Sub Regions'

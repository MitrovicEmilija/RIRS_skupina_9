...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(11839005427457342)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1811856917698340993)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1811857472710340994)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11839725458457346)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11840025977457346)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11840391323457346)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11840699452457346)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11840975705457348)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11840391323457346)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1811857472710340994)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11841290710457348)
,p_plugin_attribute_id=>wwv_flow_imp.id(11840975705457348)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11841679459457348)
,p_plugin_attribute_id=>wwv_flow_imp.id(11840975705457348)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11842017914457350)
,p_plugin_attribute_id=>wwv_flow_imp.id(11840975705457348)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11842451226457350)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11840975705457348)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11842720735457350)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11843023233457350)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11843346255457351)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11843628013457351)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11843914792457351)
,p_plugin_attribute_id=>wwv_flow_imp.id(11843628013457351)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11844342863457353)
,p_plugin_attribute_id=>wwv_flow_imp.id(11843628013457351)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11844763663457353)
,p_plugin_attribute_id=>wwv_flow_imp.id(11843628013457351)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11845226804457353)
,p_plugin_attribute_id=>wwv_flow_imp.id(11843628013457351)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11845690626457354)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(11840699452457346)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1811856917698340993)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11845941519457354)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11846255921457354)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11846538886457356)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11846852340457356)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11847112957457357)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11847448552457357)
,p_plugin_attribute_id=>wwv_flow_imp.id(11847112957457357)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11847882761457357)
,p_plugin_attribute_id=>wwv_flow_imp.id(11847112957457357)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11848276191457359)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11848556203457359)
,p_plugin_attribute_id=>wwv_flow_imp.id(11848276191457359)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11848992540457360)
,p_plugin_attribute_id=>wwv_flow_imp.id(11848276191457359)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11849326769457360)
,p_plugin_attribute_id=>wwv_flow_imp.id(11848276191457359)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11849777412457360)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11851261387457364)
,p_plugin_attribute_id=>wwv_flow_imp.id(11849777412457360)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11851606138457364)
,p_plugin_attribute_id=>wwv_flow_imp.id(11849777412457360)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11850090136457362)
,p_plugin_attribute_id=>wwv_flow_imp.id(11849777412457360)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11850458880457362)
,p_plugin_attribute_id=>wwv_flow_imp.id(11849777412457360)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11850872856457362)
,p_plugin_attribute_id=>wwv_flow_imp.id(11849777412457360)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11852036352457364)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11852307806457364)
,p_plugin_attribute_id=>wwv_flow_imp.id(11852036352457364)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11852708891457365)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1812060524867487622)
,p_plugin_id=>wwv_flow_imp.id(11839005427457342)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

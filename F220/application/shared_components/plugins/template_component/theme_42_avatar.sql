...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(11784152362457210)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11784477375457226)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11784722333457229)
,p_plugin_attribute_id=>wwv_flow_imp.id(11784477375457226)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11785184593457229)
,p_plugin_attribute_id=>wwv_flow_imp.id(11784477375457226)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11785560253457231)
,p_plugin_attribute_id=>wwv_flow_imp.id(11784477375457226)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11785904048457231)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11784477375457226)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11786275900457231)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11786528042457232)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11786856048457232)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11787154516457232)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11787415376457232)
,p_plugin_attribute_id=>wwv_flow_imp.id(11787154516457232)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11787845822457234)
,p_plugin_attribute_id=>wwv_flow_imp.id(11787154516457232)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11788266421457234)
,p_plugin_attribute_id=>wwv_flow_imp.id(11787154516457232)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11788625979457234)
,p_plugin_attribute_id=>wwv_flow_imp.id(11787154516457232)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11789025060457235)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11789318640457235)
,p_plugin_attribute_id=>wwv_flow_imp.id(11789025060457235)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11789729998457235)
,p_plugin_attribute_id=>wwv_flow_imp.id(11789025060457235)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11790114662457237)
,p_plugin_attribute_id=>wwv_flow_imp.id(11789025060457235)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11790553772457237)
,p_plugin_attribute_id=>wwv_flow_imp.id(11789025060457235)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11790949796457237)
,p_plugin_attribute_id=>wwv_flow_imp.id(11789025060457235)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11791334266457237)
,p_plugin_attribute_id=>wwv_flow_imp.id(11789025060457235)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11791757289457239)
,p_plugin_attribute_id=>wwv_flow_imp.id(11789025060457235)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11792100242457239)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1811835020939570967)
,p_plugin_id=>wwv_flow_imp.id(11784152362457210)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

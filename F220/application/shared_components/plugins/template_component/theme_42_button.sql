...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(11799338819457265)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11799692373457267)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11799999279457267)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11800276995457267)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11800536398457268)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11800828462457268)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11801146347457268)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11801433862457268)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11801730461457270)
,p_plugin_id=>wwv_flow_imp.id(11799338819457265)
,p_attribute_scope=>'COMPONENT'

...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(11812306997457292)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1939050197023528995)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1939049642011528994)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1682157578281255481)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11813272808457301)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11813526880457301)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11813837556457303)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11814141117457303)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11814423067457303)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11814778393457304)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11815065584457304)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11814423067457303)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1939050197023528995)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11815333533457304)
,p_plugin_attribute_id=>wwv_flow_imp.id(11815065584457304)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11815736322457304)
,p_plugin_attribute_id=>wwv_flow_imp.id(11815065584457304)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11816178980457306)
,p_plugin_attribute_id=>wwv_flow_imp.id(11815065584457304)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11816504980457306)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11815065584457304)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11816818967457306)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11817135025457307)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11817404121457307)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11817707133457307)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11818050544457307)
,p_plugin_attribute_id=>wwv_flow_imp.id(11817707133457307)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11818415573457309)
,p_plugin_attribute_id=>wwv_flow_imp.id(11817707133457307)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11818818300457309)
,p_plugin_attribute_id=>wwv_flow_imp.id(11817707133457307)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11819257686457309)
,p_plugin_attribute_id=>wwv_flow_imp.id(11817707133457307)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11819679406457310)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(11814778393457304)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1939049642011528994)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11819933455457310)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11820258385457310)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11820534722457310)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11820886547457312)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11821121716457312)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11821411758457312)
,p_plugin_attribute_id=>wwv_flow_imp.id(11821121716457312)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11821833588457314)
,p_plugin_attribute_id=>wwv_flow_imp.id(11821121716457312)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11822217842457314)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11822524461457314)
,p_plugin_attribute_id=>wwv_flow_imp.id(11822217842457314)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11822989199457314)
,p_plugin_attribute_id=>wwv_flow_imp.id(11822217842457314)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11823398946457315)
,p_plugin_attribute_id=>wwv_flow_imp.id(11822217842457314)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11823799458457315)
,p_plugin_attribute_id=>wwv_flow_imp.id(11822217842457314)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11824146971457315)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11824442254457317)
,p_plugin_attribute_id=>wwv_flow_imp.id(11824146971457315)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11824828368457317)
,p_plugin_attribute_id=>wwv_flow_imp.id(11824146971457315)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11825245029457317)
,p_plugin_attribute_id=>wwv_flow_imp.id(11824146971457315)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11825681436457318)
,p_plugin_attribute_id=>wwv_flow_imp.id(11824146971457315)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11826093007457318)
,p_plugin_attribute_id=>wwv_flow_imp.id(11824146971457315)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11826432715457318)
,p_plugin_attribute_id=>wwv_flow_imp.id(11824146971457315)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11826889677457320)
,p_plugin_attribute_id=>wwv_flow_imp.id(11824146971457315)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11827256310457320)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11827548467457320)
,p_plugin_attribute_id=>wwv_flow_imp.id(11827256310457320)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11827914702457321)
,p_plugin_attribute_id=>wwv_flow_imp.id(11827256310457320)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11828340072457321)
,p_plugin_attribute_id=>wwv_flow_imp.id(11827256310457320)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11828781232457321)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11829035202457321)
,p_plugin_attribute_id=>wwv_flow_imp.id(11828781232457321)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11829466361457323)
,p_plugin_attribute_id=>wwv_flow_imp.id(11828781232457321)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11829800471457323)
,p_plugin_attribute_id=>wwv_flow_imp.id(11828781232457321)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11830215704457323)
,p_plugin_attribute_id=>wwv_flow_imp.id(11828781232457321)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11830692051457325)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11830939318457325)
,p_plugin_attribute_id=>wwv_flow_imp.id(11830692051457325)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11831399654457325)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11831616657457326)
,p_plugin_attribute_id=>wwv_flow_imp.id(11831399654457325)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11832031978457326)
,p_plugin_attribute_id=>wwv_flow_imp.id(11831399654457325)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11832452874457326)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1682157578281255481)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11832776283457326)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11833061338457328)
,p_plugin_attribute_id=>wwv_flow_imp.id(11832776283457326)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11833464064457328)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11833799199457328)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1820264087239350609)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1820265346759354757)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1523312572343592179)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1806670458564943876)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1807349759295026980)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1820262152172305623)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1820263485562319480)
,p_plugin_id=>wwv_flow_imp.id(11812306997457292)
